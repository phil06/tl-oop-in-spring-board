...
import com.oop.board.domain.BoardVO;
import com.oop.board.service.BoardService;
...
public class BoardController {
	...
	@RequestMapping(value="/board/list1")
	@ResponseBody
	public String list(){
	...
	public String write(@Validated BoardVO boardVO, BindingResult bindingResult, SessionStatus sessionStatus) {
